...
class AuthorTestCase(APITestCase):
    def setUp(self):
        ...
        self.book_1 = BookFactory(author=self.author_1, title="Book 1")
        self.book_2 = BookFactory(author=self.author_1, title="Book 2")
        self.book_3 = BookFactory(author=self.author_2, title="Book 3")
    ...
    def test_authors_update(self):
        ...
        self.assertEqual(self.author_1.biography, "Author's biography here ...")
        self.assertTrue(
