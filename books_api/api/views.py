...
from books.models import Collaborator, Author, Book
from api.serializers import AuthorSerializer, BookSerializer, CollaboratorSerializer
...
class AuthorViewSet(viewsets.ViewSet):
    ...
    def retrieve(self, request, pk=None):
        # validate that the author with given id exists
        try:
    ...
    def update(serlf, request, pk=None):
        try:
            author = Author.objects.get(id=pk)
        except Author.DoesNotExist:
            return Response(
